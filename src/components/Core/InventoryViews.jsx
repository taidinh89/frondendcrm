                                    ...
                                    return (
                                        <>
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                                ...
                                                {/* Removed Ecount Tax as requested */}
                                                ...
                                                {item.inventorySummary?.vat_rate !== null && (
                                                    <DetailField label="Thuế suất (Misa)" value={`${item.inventorySummary.vat_rate}%`} isHighlight />
                                                )}
                                            </div>
                        ...
                        {rowVirtualizer.getVirtualItems().map(virtualRow => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <DataCell width={colWidths.tax} className="justify-center font-bold text-slate-500">
                                        {summary.vat_rate !== null ? `${summary.vat_rate}%` : '-'}
                                    </DataCell>

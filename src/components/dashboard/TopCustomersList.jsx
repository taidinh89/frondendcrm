// src/components/dashboard/TopCustomersList.jsx
import React from 'react';

const formatPrice = (value) => new Intl.NumberFormat('vi-VN').format(parseFloat(value) || 0) + ' đ';

export const TopCustomersList = ({ data, mode = 'revenue', onItemClick }) => {
    return (
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="inline-flex flex-col items-end text-base font-semibold text-gray-900">
                                {mode === 'revenue' ? (
                                    ...
                                    <span className="text-lg text-blue-600">{item.order_count} đơn</span>
                                )}
                            </div>
                        </div>
                    </li>

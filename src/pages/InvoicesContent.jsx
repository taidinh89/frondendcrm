...
export const InvoicesContent = () => {
    ...
    const renderCell = (inv, id) => {
        ...
        switch (id) {
            ...
            case 'partner': return <div className="truncate font-semibold text-blue-600 hover:text-blue-800 hover:underline cursor-pointer text-[14px]" onClick={(e) => {e.stopPropagation(); handleViewHtml(inv)}}>{inv.buyer_name_display || 'N/A'}</div>;

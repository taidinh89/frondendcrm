...
import { SearchOutlined, ArrowUpOutlined, UserOutlined } from '@ant-design/icons';
...
const CashReceiptsList = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, record) => (
                <div>
                    ...
                    <Tag color="blue">{record.partner_code}</Tag>
                </div>
            ),
        },
        {
        ...
        },
        {
            ...
            key: 'amount',
            align: 'right',
            render: (val) => <Text style={{ color: '#52c41a', fontWeight: 'bold' }}>{new Intl.NumberFormat('vi-VN').format(val)} đ</Text>,
    ...
    return (
        <Card title={<span><ArrowUpOutlined style={{ color: '#52c41a' }} /> NHẬT KÝ THU TIỀN (ECOUNT)</span>}>
...
export default CashReceiptsList;
